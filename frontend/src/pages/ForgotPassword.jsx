    ...
    <div className="min-h-screen bg-[#F5F5F5] relative overflow-hidden">
      ...
      <div className="flex justify-center items-center mt-10 sm:mt-20 relative z-10 px-4">
        <form onSubmit={handleSubmit} className="bg-white w-full max-w-[500px] p-6 sm:p-10 rounded-[30px] shadow-lg">
          ...
          <h1 className="text-[28px] sm:text-[38px] text-center text-[#555555] mb-4 font-bold" style={{ fontFamily: 'Playpen Sans' }}>
            Mot de passe oublié ?
          </h1>

          <p className="text-center text-[#888888] mb-8 text-sm sm:text-base" style={{ fontFamily: 'Playpen Sans' }}>
