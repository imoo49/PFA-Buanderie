  ...
  return (
    ...
    <div className="min-h-screen bg-[#F5F5F5] p-4 sm:p-6">
      ...
      <header className="flex justify-between items-start">
        ...
        <h1
          className="hidden md:block text-[30px] lg:text-[45px] text-[#555555] font-bold mt-2"
          style={{ fontFamily: 'Playpen Sans' }}
        >
          Tableau de bord
        </h1>
      ...
      <h1
        className="block md:hidden text-xl font-bold text-[#555555] mt-3 text-center"
        style={{ fontFamily: 'Playpen Sans' }}
      >
        Tableau de bord
      </h1>
      ...
      {studentAlert && (
        ...
        <div className="bg-[#FFF3CD] border border-[#FFE69C] text-[#856404] p-4 sm:p-5 rounded-[20px] mt-6 sm:mt-8 shadow-sm">
          ...
          <h3
            className="font-bold text-lg sm:text-[24px] mb-2"
            style={{ fontFamily: 'Playpen Sans' }}
          >
            Alerte Admin ⚠️
          </h3>
      ...
      <div className="mt-6 sm:mt-12">
        ...
        <h2
          className="text-2xl sm:text-[38px] font-bold text-[#555555]"
          style={{ fontFamily: 'Playpen Sans' }}
        >
          Bonjour,
      ...
      <div className="flex flex-wrap gap-4 sm:gap-8 mt-6 sm:mt-10">
        ...
        <div className="bg-white rounded-[20px] sm:rounded-[25px] p-5 sm:p-6 w-[140px] sm:w-[260px] shadow-md">
          ...
          <h1 className="text-3xl sm:text-[40px] font-bold text-[#555555]">
            {freeMachines.length}
          </h1>
        ...
        <div className="flex items-center ml-auto">
          ...
          <Link
            to="/machines"
            className="bg-[#F56B6B] text-white px-6 sm:px-8 py-3 sm:py-4 rounded-[12px] sm:rounded-[15px] font-bold shadow-md hover:scale-[1.03] transition text-sm sm:text-base"
            style={{ fontFamily: 'Playpen Sans' }}
          >
            Réserver
          </Link>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mt-10 sm:mt-14">
        ...
        <div>
          ...
          <div className="flex justify-between items-center mb-4 sm:mb-6">
            ...
            <h2
              className="text-xl sm:text-[28px] font-bold text-[#555555]"
              style={{ fontFamily: 'Playpen Sans' }}
            >
              État des machines
            </h2>
          ...
          <div className="space-y-3 sm:space-y-5">
            ...
            {machines.map((machine) => {
              ...
              return (
                ...
                <div
                  key={machine.id}
                  className="flex justify-between items-center bg-white p-4 sm:p-5 rounded-[16px] sm:rounded-[20px] shadow-sm"
                >
